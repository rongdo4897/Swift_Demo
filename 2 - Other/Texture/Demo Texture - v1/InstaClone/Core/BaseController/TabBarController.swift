...
class TabBarController: ASTabBarController, UITabBarControllerDelegate {
    ...
    private func configureControllers() {
        let navigationController1 = ASDKNavigationController(rootViewController: feedController)
        navigationController1.navigationBar.isTranslucent = false
        let navigationController2 = ASDKNavigationController(rootViewController: searchController)
        navigationController2.navigationBar.isTranslucent = false
        let navigationController4 = ASDKNavigationController(rootViewController: likedController)
        navigationController4.navigationBar.isTranslucent = false
        let navigationController5 = ASDKNavigationController(rootViewController: profileController)
