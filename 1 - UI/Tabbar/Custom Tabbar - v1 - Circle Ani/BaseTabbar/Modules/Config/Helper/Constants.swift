...
class Defined {
    ...
    // Tabbar
    static let bottomSpacing: CGFloat = 15 // cách lề dưới
    static let tabBarHeight: CGFloat = 55
    static let horizontleSpacing: CGFloat = 10 // cách trái phải
    static let tabbarWidth: CGFloat = UIScreen.main.bounds.width // độ rộng tabbar
