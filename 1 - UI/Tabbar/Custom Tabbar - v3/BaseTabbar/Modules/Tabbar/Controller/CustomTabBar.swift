...
class CustomTabBar: UIView {
    ...
    convenience init(menuItems: [TabItem], frame: CGRect) {
        ...
        for index in 0 ..< menuItems.count {
            ...
            /*
             Layout
                - Chiều dài: chiều dài màn hình / số item
                - Chiều cao: = chiều cao tabbar
                - leading: Cách lề trái tabbar 1 khoảng đã tính bên trên
                - top: Cách top tabbar 1 khoảng là 0
             */
