...
enum KeyBoardButtonStyle {
    case keyBoardCapitalButtonStyle // Trường hợp
    case keyBoardDeleteButtonStyle // Nút xóa
    case keyBoardChangedButtonStyle // Nút 123
    case keyBoardKongButtonStyle // Nút khoảng trắng
    case keyBoardConfirmButtonStyle // Nút xác nhận
}
