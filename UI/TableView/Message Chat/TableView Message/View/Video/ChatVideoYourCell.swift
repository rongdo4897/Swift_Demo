...
protocol ChatVideoDelegate: class {
    func moveData(video: String)
}

class ChatVideoYourCell: UITableViewCell {
...
extension ChatVideoYourCell: PlayerPlaybackDelegate {
